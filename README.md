...
それよりもローカルに monitor 動かす方が良かったような。

* "debug なんだからどうでもいい"と思って投げやりなんじゃね？

```
./yatt.rb:108: warning: already initialized constant TIMEOUT
./yatt.rb:44: warning: previous definition of TIMEOUT was here
./yatt.rb:109: warning: already initialized constant TAKE_A_REST
./yatt.rb:45: warning: previous definition of TAKE_A_REST was here
```

* logger.rb は名前がまずくねーか？
